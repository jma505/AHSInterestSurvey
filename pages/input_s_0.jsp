...
<html:form action="addSmallEntry.do" focus="studentFirstName">
...
<html:options collection="teacherListSmall" labelProperty="label" property="value"/>
</html:select>
</p>
<br>
</fieldset>
...
<script language="JavaScript"
  <!--
  document.forms[0].teacherId.selectedIndex = eval(getCookie("teacherIdS"));
  -->
</script>
